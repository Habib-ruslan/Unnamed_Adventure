...
public class Enemy : Entity
{
    ...
    public override void GetKnockback(float knockPow, float knockTime, float knockDamage, GameObject damageParticale)
    {
        isAgr = false;
        if (Knock_Resist < 10f)
    ...
    public virtual void isTrue(int num, bool isBool)
    {
